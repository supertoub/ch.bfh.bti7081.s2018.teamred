...
1.2 | 1 | Package und Klassen setup | Packages und Klassen gemäss UML erstellen. | | FLE | TWE | High | 3 | - | - | Open
1.3 | 1 | Farbschema CSS |  | | TWE | RRO | Low | 3 | - | - | Open
1.4 | 1 | Font/Icon Schema |  | | TWE | RRO | Low | 3 | - | - | Open
1.5 | 1 | Level Layout | Das Layout für die Level übersicht erstellen. | <ul><li>Challengebaord</li></ul> | FLE | TWE | High | 3 | - | - | Open
1.6 | 1 | Level List | Levels erstellen und auf dem Level Layout darstellen. | <ul><li>Challengebaord</li></ul> | FLE | IRI | High | 3 | - | - | Open
...
1.10 | 1 | Challenge Aktiv | Die aktive Challenge wird grün angezeigt. Ist anklickbar um die Details anzuzeigen und wird am richtigen Ort eingeordnet. | <ul><li>Challengeboard</li><li>Challengdetail</li></ul> | TBA | STH | High | 3 | - | - | Open
1.11 | 1 | Challenge Abgeschlossen | Die abgeschlossene Challenge wird ausgegraut angezeigt. Ist anklickbar um die Details anzuzeigen und wird am richtigen Ort eingeordnet. | <ul><li>Challengeboard</li><li>Challengdetail</li></ul> | TBA | STH | High | 3 | - | - | Open
